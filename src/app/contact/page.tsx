          ...
          >
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex space-x-6">
                <a 
                  href="https://www.facebook.com/stembiologyclub" 
                  target="_blank"
                ...
                <a 
                  href="https://www.instagram.com/stembiologyclub" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-primary transform hover:scale-110 transition-all"
                >
                ...
                <a 
                  href="https://www.linkedin.com/company/stembiologyclub" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-primary transform hover:scale-110 transition-all"
                >
